    ...
    <React.Fragment>
      <nav className="nav" aria-label="Primary">
        <div className="nav__brand">
          ...
          <span><b>Java AI Architect</b> · 2026 Roadmap</span>
        </div>
      ...
      <header className="hero" data-screen-label="01 Hero">
        ...
        <h1 className="hero__title">
          ...
          <span className="hero__title-100x">45 LPA AI Architect</span> <em>in 12 weeks.</em>
        </h1>
        <p className="hero__sub">
          A complete, production-grade journey from <em>script kid to agent engineer</em>.
          Every module grounded in real enterprise Java AI engineering — from Docker fundamentals
          all the way to multi-agent AI systems deployed on AWS with enterprise security.
        </p>
      ...
      <footer className="footer reveal">
        ...
        <div className="footer__meta">12 weeks · 6 phases · {totalSections} modules · 1 capstone · one Java engineer</div>
      </footer>
    </React.Fragment>
  );
}
